...
void R_DMAC0_Create(void)
{
    ...
    ICU.DMRSR0 = _BA_DMAC0_ACTIVATION_SOURCE;

    /* Set DMAC0 transfer address update and extended repeat setting */
    DMAC0.DMAMD.WORD = _8000_DMAC_SRC_ADDR_UPDATE_INCREMENT | _0080_DMAC_DST_ADDR_UPDATE_INCREMENT | 
                       _0200_DMAC0_SRC_EXT_RPT_AREA | _0002_DMAC0_DST_EXT_RPT_AREA;

    /* Set DMAC0 transfer mode, data size and repeat area */
    DMAC0.DMTMD.WORD = _0000_DMAC_TRANS_MODE_FREERUN | _2000_DMAC_REPEAT_AREA_NONE | _0100_DMAC_TRANS_DATA_SIZE_16 | 
