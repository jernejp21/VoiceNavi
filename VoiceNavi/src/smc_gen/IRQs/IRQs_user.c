...
/***********************************************************************************************************************
 * Function Name: R_IRQs_Create_UserInit
...
/***********************************************************************************************************************
 * Function Name: r_IRQs_irq13_interrupt
 * Description  : This function is IRQ13 interrupt service routine
 * Arguments    : None
 * Return Value : None
 ***********************************************************************************************************************/

void r_IRQs_irq13_interrupt(void)
{
  /* Start user code for r_IRQs_irq13_interrupt. Do not edit comment generated here */
  IRQ_handler();
  /* End user code. Do not edit comment generated here */
}
